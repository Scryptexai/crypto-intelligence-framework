...
**Total curated projects: 60 (D13–D72; registrasi batch pipeline 2026-08 + rekonstruksi/Phase 11-12 oleh CIF agent 2026-08-20).**
...
| D21 | Aptos | Layer 1 Blockchain / Smart Contract Platform (Move VM) | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Aptos.md` | `data_project/Aptos/01..12-*.docx`, diarsip ke `doc_backup/deep/Aptos_<phase>_2026-08.docx` |
| D22 | BNB Chain | Layer 1 blockchain ecosystem (EVM-compatible smart contract platform + beacon chain) | 2017– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/BNB Chain.md` | `data_project/BNB Chain/01..12-*.docx`, diarsip ke `doc_backup/deep/BNB Chain_<phase>_2026-08.docx` |
| D23 | Berachain | Layer 1 blockchain / Proof-of-Liquidity consensus | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap); **Phase 11 QA ditambahkan 2026-08-20 (CIF agent)** | `CaseStudies/Berachain.md` | `data_project/Berachain/01..12-*.docx`, diarsip ke `doc_backup/deep/Berachain_<phase>_2026-08.docx` |
| D24 | Cardano | Layer 1 Blockchain / Smart Contract Platform / Proof-of-Stake Blockchain | 2015– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Cardano.md` | `data_project/Cardano/01..12-*.docx`, diarsip ke `doc_backup/deep/Cardano_<phase>_2026-08.docx` |
| D25 | Celestia | Modular Data Availability (DA) Layer / Modular Blockchain | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Celestia.md` | `data_project/Celestia/01..12-*.docx`, diarsip ke `doc_backup/deep/Celestia_<phase>_2026-08.docx` |
| D26 | Compound | decentralized lending / borrowing protocol | 2017– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Compound.md` | `data_project/Compound/01..12-*.docx`, diarsip ke `doc_backup/deep/Compound_<phase>_2026-08.docx` |
| D27 | Cosmos | cross-chain messaging / interoperability / app-chain framework | 2017– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Cosmos.md` | `data_project/Cosmos/01..12-*.docx`, diarsip ke `doc_backup/deep/Cosmos_<phase>_2026-08.docx` |
| D28 | Curve | DeFi Automated Market Maker — stableswap/DEX optimal untuk aset bernilai serupa (stablecoin, wr | 2019– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap); **7 phases rekonstruksi 2026-08-20 via riset web (CIF agent)** | `CaseStudies/Curve.md` | `data_project/Curve/01..12-*.docx`, diarsip ke `doc_backup/deep/Curve_<phase>_2026-08.docx` |
| D29 | EOS | Layer 1 Blockchain / Smart Contract Platform | 2017– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/EOS.md` | `data_project/EOS/01..12-*.docx`, diarsip ke `doc_backup/deep/EOS_<phase>_2026-08.docx` |
| D30 | EigenLayer | restaking (restaking) / liquidity re-staking; middleware / Actively Validated Services (AVS) in | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/EigenLayer.md` | `data_project/EigenLayer/01..12-*.docx`, diarsip ke `doc_backup/deep/EigenLayer_<phase>_2026-08.docx` |
| D31 | Ethena | synthetic dollar / delta-neutral stablecoin protocol | 2023– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Ethena.md` | `data_project/Ethena/01..12-*.docx`, diarsip ke `doc_backup/deep/Ethena_<phase>_2026-08.docx` |
| D32 | EtherFi | Non-custodial liquid staking & restaking; decentralized finance (DeFi) — specifically liquid re | 2023– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/EtherFi.md` | `data_project/EtherFi/01..12-*.docx`, diarsip ke `doc_backup/deep/EtherFi_<phase>_2026-08.docx` |
| D33 | Ethereum | Smart contract platform / Layer 1 blockchain | 2014– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Ethereum.md` | `data_project/Ethereum/01..12-*.docx`, diarsip ke `doc_backup/deep/Ethereum_<phase>_2026-08.docx` |
| D34 | Friend.tech | SocialFi / Social Finance / Creator Economy Platform | 2023– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Friend.tech.md` | `data_project/Friend.tech/01..12-*.docx`, diarsip ke `doc_backup/deep/Friend.tech_<phase>_2026-08.docx` |
| D35 | Grass | Token Address | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Grass.md` | `data_project/Grass/01..12-*.docx`, diarsip ke `doc_backup/deep/Grass_<phase>_2026-08.docx` |
| D36 | Helium | Decentralized Physical Infrastructure Network (DePIN) / Wireless Network (IoT LoRaWAN, 5G CBRS, | 2018– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Helium.md` | `data_project/Helium/01..12-*.docx`, diarsip ke `doc_backup/deep/Helium_<phase>_2026-08.docx` |
| D37 | Hyperliquid | Layer 1 Blockchain / Decentralized Exchange (Perpetual Futures & Spot) / On-chain Order Book (C | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Hyperliquid.md` | `data_project/Hyperliquid/01..12-*.docx`, diarsip ke `doc_backup/deep/Hyperliquid_<phase>_2026-08.docx` |
| D38 | Injective | Layer-1 blockchain for decentralized finance / cross-chain derivatives exchange | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Injective.md` | `data_project/Injective/01..12-*.docx`, diarsip ke `doc_backup/deep/Injective_<phase>_2026-08.docx` |
| D39 | Irys | Permanent data provenance layer / Layer 1 blockchain | 2023– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Irys.md` | `data_project/Irys/01..12-*.docx`, diarsip ke `doc_backup/deep/Irys_<phase>_2026-08.docx` |
| D40 | Jito | MEV infrastructure / Liquid Staking / Validator Client (Solana) | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Jito.md` | `data_project/Jito/01..12-*.docx`, diarsip ke `doc_backup/deep/Jito_<phase>_2026-08.docx` |
| D41 | Jupiter | DEX aggregator / swap infrastructure | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Jupiter.md` | `data_project/Jupiter/01..12-*.docx`, diarsip ke `doc_backup/deep/Jupiter_<phase>_2026-08.docx` |
| D42 | Kamino | DeFi — automated concentrated liquidity management / lending & borrowing / leveraged vaults / p | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Kamino.md` | `data_project/Kamino/01..12-*.docx`, diarsip ke `doc_backup/deep/Kamino_<phase>_2026-08.docx` |
| D43 | Lido | liquid staking / staking infrastructure | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Lido.md` | `data_project/Lido/01..12-*.docx`, diarsip ke `doc_backup/deep/Lido_<phase>_2026-08.docx` |
| D44 | Linea | Ethereum Layer 2 / Type-2 zkEVM Rollup (validity proof ke Ethereum L1) | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap); **phases 1/2/5 rekonstruksi 2026-08-20 via riset web (CIF agent)** | `CaseStudies/Linea.md` | `data_project/Linea/01..12-*.docx`, diarsip ke `doc_backup/deep/Linea_<phase>_2026-08.docx` |
| D45 | MakerDAO | Decentralized Collateralized Debt Position (CDP) Protocol / Algorithmic Stablecoin Issuance / D | 2015– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/MakerDAO.md` | `data_project/MakerDAO/01..12-*.docx`, diarsip ke `doc_backup/deep/MakerDAO_<phase>_2026-08.docx` |
| D46 | MegaETH | High-performance Ethereum Layer 2 / Real-time blockchain | 2023– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/MegaETH.md` | `data_project/MegaETH/01..12-*.docx`, diarsip ke `doc_backup/deep/MegaETH_<phase>_2026-08.docx` |
| D47 | Monad | High-performance Layer 1 / Parallel EVM | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Monad.md` | `data_project/Monad/01..12-*.docx`, diarsip ke `doc_backup/deep/Monad_<phase>_2026-08.docx` |
| D48 | Movement Labs | Move-based modular blockchain stack / Layer 2 / MoveVM execution environment | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Movement Labs.md` | `data_project/Movement Labs/01..12-*.docx`, diarsip ke `doc_backup/deep/Movement Labs_<phase>_2026-08.docx` |
| D49 | Near | Community / Grants | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Near.md` | `data_project/Near/01..12-*.docx`, diarsip ke `doc_backup/deep/Near_<phase>_2026-08.docx` |
| D50 | Notcoin | Telegram Mini App / Tap-to-Earn Game / Consumer Crypto Onboarding | 2024– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Notcoin.md` | `data_project/Notcoin/01..12-*.docx`, diarsip ke `doc_backup/deep/Notcoin_<phase>_2026-08.docx` |
| D51 | OlympusDAO | Protocol-owned liquidity / algorithmic currency / decentralized reserve currency | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/OlympusDAO.md` | `data_project/OlympusDAO/01..12-*.docx`, diarsip ke `doc_backup/deep/OlympusDAO_<phase>_2026-08.docx` |
| D52 | Optimism | Ethereum Layer 2 scaling / Optimistic Rollup | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Optimism.md` | `data_project/Optimism/01..12-*.docx`, diarsip ke `doc_backup/deep/Optimism_<phase>_2026-08.docx` |
| D53 | Polkadot | Heterogeneous multi-chain network / blockchain interoperability protocol | 2017– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Polkadot.md` | `data_project/Polkadot/01..12-*.docx`, diarsip ke `doc_backup/deep/Polkadot_<phase>_2026-08.docx` |
| D54 | Polygon | Layer 2 scaling / Ethereum scaling ecosystem (multi-chain: PoS, zkEVM, CDK, Miden, Avail) | 2019– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Polygon.md` | `data_project/Polygon/01..12-*.docx`, diarsip ke `doc_backup/deep/Polygon_<phase>_2026-08.docx` |
| D55 | Polymarket | Decentralized prediction market / information market | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Polymarket.md` | `data_project/Polymarket/01..12-*.docx`, diarsip ke `doc_backup/deep/Polymarket_<phase>_2026-08.docx` |
| D56 | Pump.fun | Memecoin launchpad / fair launch platform dengan bonding curve | 2024– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Pump.fun.md` | `data_project/Pump.fun/01..12-*.docx`, diarsip ke `doc_backup/deep/Pump.fun_<phase>_2026-08.docx` |
| D57 | Pyth | Oracle network / price feed infrastructure (cross-chain data delivery) | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Pyth.md` | `data_project/Pyth/01..12-*.docx`, diarsip ke `doc_backup/deep/Pyth_<phase>_2026-08.docx` |
| D58 | Render | Decentralized GPU compute marketplace / distributed rendering network | 2017– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Render.md` | `data_project/Render/01..12-*.docx`, diarsip ke `doc_backup/deep/Render_<phase>_2026-08.docx` |
| D59 | Scroll | zkEVM Layer 2 / Ethereum scaling | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Scroll.md` | `data_project/Scroll/01..12-*.docx`, diarsip ke `doc_backup/deep/Scroll_<phase>_2026-08.docx` |
| D60 | Sei | Layer 1 blockchain optimized for trading / high-performance DeFi | 2022– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Sei.md` | `data_project/Sei/01..12-*.docx`, diarsip ke `doc_backup/deep/Sei_<phase>_2026-08.docx` |
| D61 | Solana | Layer 1 blockchain / smart contract platform | 2017– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap); **Phase 11 QA ditambahkan 2026-08-20 (CIF agent)** | `CaseStudies/Solana.md` | `data_project/Solana/01..12-*.docx`, diarsip ke `doc_backup/deep/Solana_<phase>_2026-08.docx` |
| D62 | Starknet | Rollup sebagai Layer 2 (validium/ZK-rollup hibrida) — lebih spesifik: general-purpose ZK-rollup | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Starknet.md` | `data_project/Starknet/01..12-*.docx`, diarsip ke `doc_backup/deep/Starknet_<phase>_2026-08.docx` |
| D63 | Sui | Layer 1 blockchain / smart contract platform | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Sui.md` | `data_project/Sui/01..12-*.docx`, diarsip ke `doc_backup/deep/Sui_<phase>_2026-08.docx` |
| D64 | SushiSwap | Automated Market Maker (AMM) DEX / Decentralized Exchange Aggregator / Cross-chain DEX | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/SushiSwap.md` | `data_project/SushiSwap/01..12-*.docx`, diarsip ke `doc_backup/deep/SushiSwap_<phase>_2026-08.docx` |
| D65 | Terra | Layer 1 blockchain / algorithmic stablecoin ecosystem | 2019– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Terra.md` | `data_project/Terra/01..12-*.docx`, diarsip ke `doc_backup/deep/Terra_<phase>_2026-08.docx` |
| D66 | Uniswap | decentralized exchange / automated market maker | 2018– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Uniswap.md` | `data_project/Uniswap/01..12-*.docx`, diarsip ke `doc_backup/deep/Uniswap_<phase>_2026-08.docx` |
| D67 | Vana | data liquidity / data DAO infrastructure | 2021– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Vana.md` | `data_project/Vana/01..12-*.docx`, diarsip ke `doc_backup/deep/Vana_<phase>_2026-08.docx` |
| D68 | Walrus | Decentralized programmable data storage protocol (blob storage) di atas Sui | 2024– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap); **phases 1/2/3/4/6 rekonstruksi 2026-08-20 via riset web (CIF agent)** | `CaseStudies/Walrus.md` | `data_project/Walrus/01..12-*.docx`, diarsip ke `doc_backup/deep/Walrus_<phase>_2026-08.docx` |
| D69 | Wormhole | cross-chain messaging / interoperability | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap) | `CaseStudies/Wormhole.md` | `data_project/Wormhole/01..12-*.docx`, diarsip ke `doc_backup/deep/Wormhole_<phase>_2026-08.docx` |
| D70 | Yearn Finance | DeFi yield aggregator/optimizer (vaults & strategi yield otomatis) | 2020– | Deep Research (DeepSeek/Nemotron via gateway), Format v3 Dependency Pipeline Track C (12/12 phases — Phase 11 QA + Phase 12 Airdrop lengkap); **6 phases rekonstruksi 2026-08-20 via riset web (CIF agent)** | `CaseStudies/Yearn Finance.md` | `data_project/Yearn Finance/01..12-*.docx`, diarsip ke `doc_backup/deep/Yearn Finance_<phase>_2026-08.docx` |
...
## Pioneer Batch 03 (Summary tier — web research langsung, 2026-08-20)

_Tier: Summary · breadth batch pertama pasca-reset; riset web publik dengan provenance per file._

| # | Project | Category | Era | Source | File | Raw source |
|---|---------|----------|-----|--------|------|-----------|
| 1 | Pendle | DeFi / Yield Tokenization (PT/YT) | 2021– | Web research (Messari, Datawallet, Uphold), 2026-08-20 | `Pioneer/Pendle.md` | publik (tautan di dossier) |
